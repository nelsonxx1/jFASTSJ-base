 ...
 * @author bc
 */
public class CoberturaGridInternalController extends DefaultGridInternalController {

    public CoberturaGridInternalController(String classNameModelFullPath, String getMethodName, GridControl miGrid, DefaultGridInternalController... listSubGrids) {
    ...
    public Response insertRecords(int[] rowNumbers, ArrayList newValueObjects) throws Exception {
        ...
        if (getSet() != null) {
            ...
            try {
                ...
                //getSet().add(o);
                ((Cobertura) o).setRamo((Ramo) super.beanVO);
