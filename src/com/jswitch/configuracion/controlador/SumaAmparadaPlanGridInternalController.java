...
public class SumaAmparadaPlanGridInternalController extends DefaultGridInternalController {
    ...
    public SumaAmparadaPlanGridInternalController(String classNameModelFullPath, String getMethodName, GridControl miGrid, DefaultGridInternalController... listSubGrids) {
    ...
    public Response insertRecords(int[] rowNumbers, ArrayList newValueObjects) throws Exception {
        ...
        if (getSet() != null) {
            ...
            try {
                ...
                //getSet().add(o);
                ((SumaAmparada) o).setPlan((Plan) super.beanVO);
