 ...
 * @author bc
 */
public class DiagnosticoGridInternalController extends DefaultGridInternalController {

    private JTabbedPane pane;

    public DiagnosticoGridInternalController(String classNameModelFullPath, String getMethodName, GridControl miGrid, DefaultGridInternalController... listSubGrids) {
    ...
    public Response loadData(int action,
        ...
        List al;
        if (beanVO != null) {
            al = s.createQuery("FROM " + Diagnostico.class.getName() + " WHERE especialidad.id=:especialidadId").
                    setLong("especialidadId", ((Especialidad) beanVO).getId()).list();
        } else {
