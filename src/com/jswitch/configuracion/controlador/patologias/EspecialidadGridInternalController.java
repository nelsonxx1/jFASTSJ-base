 ...
 * @author bc
 */
public class EspecialidadGridInternalController extends DefaultGridInternalController {
    private JTabbedPane pane;

    public EspecialidadGridInternalController(String classNameModelFullPath, String getMethodName, GridControl miGrid,DefaultGridInternalController... listSubGrids) {
    ...
    public Response loadData(int action,
        ...
        List al;
        if (beanVO != null) {
            al = s.createQuery("FROM " + Especialidad.class.getName() + " WHERE ramo.id=:ramoId").
                    setLong("ramoId", ((Ramo) beanVO).getId()).list();
        } else {
            al = new ArrayList<Especialidad>(0);
        }
    ...
    public Response insertRecords(int[] rowNumbers, ArrayList newValueObjects) throws Exception {
        ...
        if (getSet() != null) {
            ...
            try {
                ...
                //getSet().add(o);
                ((Especialidad) o).setRamo((Ramo) super.beanVO);
