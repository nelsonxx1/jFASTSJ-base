...
//
                ...
                if (cant == 0) {
                    ...
                    if (!detailFramePath.equalsIgnoreCase(
                        ...
                        try {
                            ...
                            if (beanVO instanceof OrdenDePago) {
                                ((OrdenDePago) beanVO).setPersonaPago(
                                        (Persona) q.uniqueResult());
                            }
                        ...
                        new PersonasDetailController(null,
                                (Persona) q.uniqueResult(), null);
                    }
                } else {
                    if (tp) {
                    ...
                    new PersonaGridControllerWhitSQL(
                            ...
                            null, sqlRec + where2, values.toArray(), tt);
                }
            } catch (Exception ex) {
                ex.printStackTrace();
