 ...
 */
public class EtapaSiniestroGridFrame extends DefaultGridFrame {

    public EtapaSiniestroGridFrame() {
    }
    ...
    public void inicializar(GridDataLocator gridDataLocator,
        ...
        DefaultLookupControllerPorNombre l = new DefaultLookupControllerPorNombre(EstatusSiniestro.class.getName());
        l.addLookup2ParentLink("estatusSiniestro");
